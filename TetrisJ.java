/**
 * TetrisJ class is a subclass of TetrisPiece class. 
 *
...
public class TetrisJ extends TetrisPiece {
	...
	/**
	 * Sets the J piece to be vertical
	 */
	private void setUp(){
	...
	/**
	 * Sets the J piece to be upside down
	 */
	...
	/**
	 * Sets the J piece to be turned to the right
	 */
	...
	/**
	 * Sets the J piece to be turned to the left
	 */
